...
export const enum__locales = pgEnum('enum__locales', ['en', 'ms'])
...
export const enum_pages_hero_background_blob = pgEnum('enum_pages_hero_background_blob', [
  'mistSage',
  'warmSand',
  'none',
])
...
export const enum__pages_v_version_hero_background_blob = pgEnum(
  'enum__pages_v_version_hero_background_blob',
  ['mistSage', 'warmSand', 'none'],
)
export const enum__pages_v_version_status = pgEnum('enum__pages_v_version_status', [
  'draft',
  'published',
])
export const enum__pages_v_published_locale = pgEnum('enum__pages_v_published_locale', ['en', 'ms'])
...
export const enum__posts_v_published_locale = pgEnum('enum__posts_v_published_locale', ['en', 'ms'])
export const enum_users_role = pgEnum('enum_users_role', ['admin', 'provider', 'client'])
export const enum_provider_profiles_approaches_name = pgEnum(
  'enum_provider_profiles_approaches_name',
  [
    'CBT',
    'DBT',
    'EMDR',
...
export const enum_provider_profiles_session_formats_format = pgEnum(
  'enum_provider_profiles_session_formats_format',
  ['online', 'in-person', 'both'],
)
export const enum_provider_profiles_approval_status = pgEnum(
  'enum_provider_profiles_approval_status',
  ['pending', 'approved', 'rejected'],
)
export const enum_provider_profiles_status = pgEnum('enum_provider_profiles_status', [
  'active',
  'inactive',
])
export const enum_services_category = pgEnum('enum_services_category', [
  'individual',
  'couples',
  'family',
  'group',
...
export const enum_reviews_author_age = pgEnum('enum_reviews_author_age', [
  '18-24',
  '25-34',
  '35-44',
  '45-54',
...
export const enum_bookings_format = pgEnum('enum_bookings_format', ['online', 'in-person'])
...
export const enum_bookings_payment_status = pgEnum('enum_bookings_payment_status', [
  'pending',
  'paid',
  'refunded',
])
...
export const enum_header_mobile_menu_items_link_type = pgEnum(
  'enum_header_mobile_menu_items_link_type',
  ['reference', 'custom'],
)
...
export const pages_hero_suggestions = pgTable(
  'pages_hero_suggestions',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => [
    index('pages_hero_suggestions_order_idx').on(columns._order),
    index('pages_hero_suggestions_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_hero_suggestions_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const pages_blocks_service_carousel = pgTable(
  'pages_blocks_service_carousel',
  {
    ...
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    heading: varchar('heading').default('How can we help?'),
    subheading: varchar('subheading').default(
      'Browse our services to find the right support for you.',
    ),
    viewAllLink_label: varchar('view_all_link_label').default('View all services'),
    viewAllLink_url: varchar('view_all_link_url').default('/providers'),
    blockName: varchar('block_name'),
  },
  (columns) => [
    index('pages_blocks_service_carousel_order_idx').on(columns._order),
    index('pages_blocks_service_carousel_parent_id_idx').on(columns._parentID),
    index('pages_blocks_service_carousel_path_idx').on(columns._path),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_service_carousel_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const pages_blocks_testimonials = pgTable(
  'pages_blocks_testimonials',
  {
    ...
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    heading: varchar('heading').default('What people are saying'),
    blockName: varchar('block_name'),
  },
  (columns) => [
...
export const pages_blocks_featured_posts = pgTable(
  'pages_blocks_featured_posts',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    heading: varchar('heading').default('Latest articles'),
    viewAllLink_label: varchar('view_all_link_label').default('View all articles'),
    viewAllLink_url: varchar('view_all_link_url').default('/posts'),
    blockName: varchar('block_name'),
  },
  (columns) => [
    index('pages_blocks_featured_posts_order_idx').on(columns._order),
    index('pages_blocks_featured_posts_parent_id_idx').on(columns._parentID),
    index('pages_blocks_featured_posts_path_idx').on(columns._path),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_featured_posts_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const pages = pgTable(
  'pages',
  {
    ...
    hero_searchPlaceholder: varchar('hero_search_placeholder').default('What are you looking for?'),
    hero_backgroundBlob:
      enum_pages_hero_background_blob('hero_background_blob').default('mistSage'),
...
export const pages_rels = pgTable(
  'pages_rels',
  {
    ...
    'provider-profilesID': integer('provider_profiles_id'),
  ...
  (columns) => [
    ...
    index('pages_rels_provider_profiles_id_idx').on(columns['provider-profilesID']),
    ...
    foreignKey({
      columns: [columns['provider-profilesID']],
      foreignColumns: [provider_profiles.id],
      name: 'pages_rels_provider_profiles_fk',
    }).onDelete('cascade'),
    foreignKey({
...
export const _pages_v_version_hero_suggestions = pgTable(
  '_pages_v_version_hero_suggestions',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_version_hero_suggestions_order_idx').on(columns._order),
    index('_pages_v_version_hero_suggestions_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_version_hero_suggestions_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const _pages_v_blocks_service_carousel = pgTable(
  '_pages_v_blocks_service_carousel',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => [
    index('_pages_v_blocks_service_carousel_order_idx').on(columns._order),
    index('_pages_v_blocks_service_carousel_parent_id_idx').on(columns._parentID),
    index('_pages_v_blocks_service_carousel_path_idx').on(columns._path),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_service_carousel_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const _pages_v_blocks_featured_posts = pgTable(
  '_pages_v_blocks_featured_posts',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => [
    index('_pages_v_blocks_featured_posts_order_idx').on(columns._order),
    index('_pages_v_blocks_featured_posts_parent_id_idx').on(columns._parentID),
    index('_pages_v_blocks_featured_posts_path_idx').on(columns._path),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_featured_posts_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const _pages_v = pgTable(
  '_pages_v',
  {
    ...
    version_hero_searchPlaceholder: varchar('version_hero_search_placeholder').default(
      'What are you looking for?',
    ),
    version_hero_backgroundBlob: enum__pages_v_version_hero_background_blob(
      'version_hero_background_blob',
    ).default('mistSage'),
...
export const _pages_v_rels = pgTable(
  ...
  (columns) => [
    ...
    index('_pages_v_rels_provider_profiles_id_idx').on(columns['provider-profilesID']),
    index('_pages_v_rels_categories_id_idx').on(columns.categoriesID),
    index('_pages_v_rels_services_id_idx').on(columns.servicesID),
    foreignKey({
      columns: [columns['parent']],
      foreignColumns: [_pages_v.id],
    ...
    foreignKey({
      columns: [columns['provider-profilesID']],
      foreignColumns: [provider_profiles.id],
      name: '_pages_v_rels_provider_profiles_fk',
    }).onDelete('cascade'),
    foreignKey({
      columns: [columns['categoriesID']],
      foreignColumns: [categories.id],
...
export const provider_profiles_credentials = pgTable(
  'provider_profiles_credentials',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => [
    index('provider_profiles_credentials_order_idx').on(columns._order),
    index('provider_profiles_credentials_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [provider_profiles.id],
      name: 'provider_profiles_credentials_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const provider_profiles_approaches = pgTable(
  'provider_profiles_approaches',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    name: enum_provider_profiles_approaches_name('name'),
  },
  (columns) => [
    index('provider_profiles_approaches_order_idx').on(columns._order),
    index('provider_profiles_approaches_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [provider_profiles.id],
      name: 'provider_profiles_approaches_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const provider_profiles_faq = pgTable(
  'provider_profiles_faq',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => [
    index('provider_profiles_faq_order_idx').on(columns._order),
    index('provider_profiles_faq_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [provider_profiles.id],
      name: 'provider_profiles_faq_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const provider_profiles_session_formats = pgTable(
  'provider_profiles_session_formats',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    format: enum_provider_profiles_session_formats_format('format').notNull(),
    location: varchar('location'),
  },
  (columns) => [
    index('provider_profiles_session_formats_order_idx').on(columns._order),
    index('provider_profiles_session_formats_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [provider_profiles.id],
      name: 'provider_profiles_session_formats_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const provider_profiles = pgTable(
  'provider_profiles',
  {
    id: serial('id').primaryKey(),
    ...
    about: jsonb('about'),
    philosophy: jsonb('philosophy'),
    sessionFee: numeric('session_fee', { mode: 'number' }).notNull(),
    ...
    intakeForm: integer('intake_form_id').references(() => forms.id, {
      onDelete: 'set null',
    }),
    intakeFormRequired: boolean('intake_form_required').default(false),
    approvalStatus: enum_provider_profiles_approval_status('approval_status')
      .notNull()
      .default('pending'),
    ...
    status: enum_provider_profiles_status('status').notNull().default('active'),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
  ...
  (columns) => [
    uniqueIndex('provider_profiles_user_idx').on(columns.user),
    uniqueIndex('provider_profiles_slug_idx').on(columns.slug),
    index('provider_profiles_cover_image_idx').on(columns.coverImage),
    index('provider_profiles_intake_form_idx').on(columns.intakeForm),
    index('provider_profiles_approved_by_idx').on(columns.approvedBy),
    index('provider_profiles_meta_meta_image_idx').on(columns.meta_image),
    index('provider_profiles_updated_at_idx').on(columns.updatedAt),
    index('provider_profiles_created_at_idx').on(columns.createdAt),
  ],
)

export const provider_profiles_rels = pgTable(
  'provider_profiles_rels',
  {
    id: serial('id').primaryKey(),
    order: integer('order'),
    parent: integer('parent_id').notNull(),
    path: varchar('path').notNull(),
    languagesID: integer('languages_id'),
    servicesID: integer('services_id'),
  },
  (columns) => [
    index('provider_profiles_rels_order_idx').on(columns.order),
    index('provider_profiles_rels_parent_idx').on(columns.parent),
    index('provider_profiles_rels_path_idx').on(columns.path),
    index('provider_profiles_rels_languages_id_idx').on(columns.languagesID),
    index('provider_profiles_rels_services_id_idx').on(columns.servicesID),
    foreignKey({
      columns: [columns['parent']],
      foreignColumns: [provider_profiles.id],
      name: 'provider_profiles_rels_parent_fk',
    }).onDelete('cascade'),
    foreignKey({
      columns: [columns['languagesID']],
      foreignColumns: [languages.id],
      name: 'provider_profiles_rels_languages_fk',
    }).onDelete('cascade'),
    foreignKey({
      columns: [columns['servicesID']],
      foreignColumns: [services.id],
      name: 'provider_profiles_rels_services_fk',
    }).onDelete('cascade'),
  ],
)
...
export const services = pgTable(
  'services',
  {
    ...
    category: enum_services_category('category'),
...
export const reviews = pgTable(
  'reviews',
  {
    ...
    authorAge: enum_reviews_author_age('author_age'),
  ...
  (columns) => [
    index('reviews_provider_idx').on(columns.provider),
...
export const languages = pgTable(
  ...
  (columns) => [
    uniqueIndex('languages_code_idx').on(columns.code),
...
export const bookings = pgTable(
  'bookings',
  {
    ...
    duration: numeric('duration', { mode: 'number' }).default(50),
    format: enum_bookings_format('format').notNull(),
    status: enum_bookings_status('status').notNull().default('pending'),
    clientName: varchar('client_name'),
    clientEmail: varchar('client_email').notNull(),
    clientPhone: varchar('client_phone'),
    notes: varchar('notes'),
    intakeFormResponse: jsonb('intake_form_response'),
    paymentStatus: enum_bookings_payment_status('payment_status').default('pending'),
  ...
  (columns) => [
    index('bookings_provider_idx').on(columns.provider),
...
export const match_responses_responses = pgTable(
  'match_responses_responses',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => [
    index('match_responses_responses_order_idx').on(columns._order),
    index('match_responses_responses_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [match_responses.id],
      name: 'match_responses_responses_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const match_responses = pgTable(
  'match_responses',
  {
    id: serial('id').primaryKey(),
    recommendedProvider: integer('recommended_provider_id').references(() => provider_profiles.id, {
      onDelete: 'set null',
    }),
  ...
  (columns) => [
    index('match_responses_recommended_provider_idx').on(columns.recommendedProvider),
    index('match_responses_updated_at_idx').on(columns.updatedAt),
    index('match_responses_created_at_idx').on(columns.createdAt),
  ],
)

export const match_responses_rels = pgTable(
  'match_responses_rels',
  {
    id: serial('id').primaryKey(),
    order: integer('order'),
    parent: integer('parent_id').notNull(),
  ...
  (columns) => [
    index('match_responses_rels_order_idx').on(columns.order),
    index('match_responses_rels_parent_idx').on(columns.parent),
    index('match_responses_rels_path_idx').on(columns.path),
    index('match_responses_rels_provider_profiles_id_idx').on(columns['provider-profilesID']),
    foreignKey({
      columns: [columns['parent']],
      foreignColumns: [match_responses.id],
      name: 'match_responses_rels_parent_fk',
    }).onDelete('cascade'),
    foreignKey({
      columns: [columns['provider-profilesID']],
      foreignColumns: [provider_profiles.id],
      name: 'match_responses_rels_provider_profiles_fk',
    }).onDelete('cascade'),
  ],
)
...
export const payload_locked_documents_rels = pgTable(
  'payload_locked_documents_rels',
  {
    ...
    'match-responsesID': integer('match_responses_id'),
  ...
  (columns) => [
    ...
    index('payload_locked_documents_rels_provider_profiles_id_idx').on(
      columns['provider-profilesID'],
    ),
    ...
    index('payload_locked_documents_rels_match_responses_id_idx').on(columns['match-responsesID']),
    ...
    foreignKey({
      columns: [columns['provider-profilesID']],
      foreignColumns: [provider_profiles.id],
      name: 'payload_locked_documents_rels_provider_profiles_fk',
    }).onDelete('cascade'),
    foreignKey({
      columns: [columns['servicesID']],
      foreignColumns: [services.id],
    ...
    foreignKey({
      columns: [columns['match-responsesID']],
      foreignColumns: [match_responses.id],
      name: 'payload_locked_documents_rels_match_responses_fk',
    }).onDelete('cascade'),
    foreignKey({
...
export const header_mobile_menu_items = pgTable(
  'header_mobile_menu_items',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type: enum_header_mobile_menu_items_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    link_label: varchar('link_label').notNull(),
  },
  (columns) => [
    index('header_mobile_menu_items_order_idx').on(columns._order),
    index('header_mobile_menu_items_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [header.id],
      name: 'header_mobile_menu_items_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const header = pgTable('header', {
  id: serial('id').primaryKey(),
  audienceToggle_helpSeekerLabel: varchar('audience_toggle_help_seeker_label').default(
    'For Help Seekers',
  ),
  audienceToggle_helpSeekerUrl: varchar('audience_toggle_help_seeker_url').default('/'),
  audienceToggle_therapistLabel: varchar('audience_toggle_therapist_label').default(
    'For Therapists',
  ),
  audienceToggle_therapistUrl: varchar('audience_toggle_therapist_url').default('/for-therapists'),
  ctaButton_label: varchar('cta_button_label').default('List Your Services'),
  ctaButton_url: varchar('cta_button_url').default('/for-therapists/list'),
  updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 }),
  createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 }),
})
...
export const header_rels = pgTable(
  ...
  (columns) => [
    ...
    index('header_rels_provider_profiles_id_idx').on(columns['provider-profilesID']),
    foreignKey({
      columns: [columns['parent']],
      foreignColumns: [header.id],
    ...
    foreignKey({
      columns: [columns['provider-profilesID']],
      foreignColumns: [provider_profiles.id],
      name: 'header_rels_provider_profiles_fk',
    }).onDelete('cascade'),
  ],
)
...
export const footer_rels = pgTable(
  ...
  (columns) => [
    ...
    index('footer_rels_provider_profiles_id_idx').on(columns['provider-profilesID']),
    foreignKey({
      columns: [columns['parent']],
      foreignColumns: [footer.id],
    ...
    foreignKey({
      columns: [columns['provider-profilesID']],
      foreignColumns: [provider_profiles.id],
      name: 'footer_rels_provider_profiles_fk',
    }).onDelete('cascade'),
  ],
)
...
export const relations_pages_hero_suggestions = relations(pages_hero_suggestions, ({ one }) => ({
  _parentID: one(pages, {
    fields: [pages_hero_suggestions._parentID],
    references: [pages.id],
    relationName: 'hero_suggestions',
  }),
}))
...
export const relations_pages_blocks_service_carousel = relations(
  pages_blocks_service_carousel,
  ({ one }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_service_carousel._parentID],
      references: [pages.id],
      relationName: '_blocks_serviceCarousel',
    }),
  }),
)
...
export const relations_pages_blocks_featured_posts = relations(
  pages_blocks_featured_posts,
  ({ one }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_featured_posts._parentID],
      references: [pages.id],
      relationName: '_blocks_featuredPosts',
    }),
  }),
)
...
export const relations_pages_rels = relations(pages_rels, ({ one }) => ({
  ...
  'provider-profilesID': one(provider_profiles, {
    fields: [pages_rels['provider-profilesID']],
    references: [provider_profiles.id],
    relationName: 'provider-profiles',
  }),
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  hero_suggestions: many(pages_hero_suggestions, {
    relationName: 'hero_suggestions',
  }),
  ...
  _blocks_serviceCarousel: many(pages_blocks_service_carousel, {
    relationName: '_blocks_serviceCarousel',
  }),
  ...
  _blocks_featuredPosts: many(pages_blocks_featured_posts, {
    relationName: '_blocks_featuredPosts',
  }),
...
export const relations__pages_v_version_hero_suggestions = relations(
  _pages_v_version_hero_suggestions,
  ({ one }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_version_hero_suggestions._parentID],
      references: [_pages_v.id],
      relationName: 'version_hero_suggestions',
    }),
  }),
)
...
export const relations__pages_v_blocks_service_carousel = relations(
  _pages_v_blocks_service_carousel,
  ({ one }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_service_carousel._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_serviceCarousel',
    }),
  }),
...
export const relations__pages_v_blocks_featured_posts = relations(
  _pages_v_blocks_featured_posts,
  ({ one }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_featured_posts._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_featuredPosts',
    }),
  }),
...
export const relations__pages_v_rels = relations(_pages_v_rels, ({ one }) => ({
  ...
  'provider-profilesID': one(provider_profiles, {
    fields: [_pages_v_rels['provider-profilesID']],
    references: [provider_profiles.id],
    relationName: 'provider-profiles',
  }),
  categoriesID: one(categories, {
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  version_hero_suggestions: many(_pages_v_version_hero_suggestions, {
    relationName: 'version_hero_suggestions',
  }),
  ...
  _blocks_serviceCarousel: many(_pages_v_blocks_service_carousel, {
    relationName: '_blocks_serviceCarousel',
  }),
  ...
  _blocks_featuredPosts: many(_pages_v_blocks_featured_posts, {
    relationName: '_blocks_featuredPosts',
  }),
...
export const relations_provider_profiles_credentials = relations(
  provider_profiles_credentials,
  ({ one }) => ({
    _parentID: one(provider_profiles, {
      fields: [provider_profiles_credentials._parentID],
      references: [provider_profiles.id],
      relationName: 'credentials',
    }),
  }),
)
export const relations_provider_profiles_approaches = relations(
  provider_profiles_approaches,
  ({ one }) => ({
    _parentID: one(provider_profiles, {
      fields: [provider_profiles_approaches._parentID],
      references: [provider_profiles.id],
      relationName: 'approaches',
    }),
  }),
)
export const relations_provider_profiles_faq = relations(provider_profiles_faq, ({ one }) => ({
  _parentID: one(provider_profiles, {
    fields: [provider_profiles_faq._parentID],
    references: [provider_profiles.id],
    relationName: 'faq',
  }),
}))
export const relations_provider_profiles_session_formats = relations(
  provider_profiles_session_formats,
  ({ one }) => ({
    _parentID: one(provider_profiles, {
      fields: [provider_profiles_session_formats._parentID],
      references: [provider_profiles.id],
      relationName: 'sessionFormats',
    }),
  }),
)
export const relations_provider_profiles_rels = relations(provider_profiles_rels, ({ one }) => ({
  parent: one(provider_profiles, {
    fields: [provider_profiles_rels.parent],
    references: [provider_profiles.id],
    relationName: '_rels',
  }),
  languagesID: one(languages, {
    fields: [provider_profiles_rels.languagesID],
    references: [languages.id],
    relationName: 'languages',
  }),
  servicesID: one(services, {
    fields: [provider_profiles_rels.servicesID],
    references: [services.id],
    relationName: 'services',
  }),
}))
export const relations_provider_profiles = relations(provider_profiles, ({ one, many }) => ({
  user: one(users, {
    fields: [provider_profiles.user],
    references: [users.id],
    relationName: 'user',
  }),
  coverImage: one(media, {
    fields: [provider_profiles.coverImage],
    references: [media.id],
    relationName: 'coverImage',
  }),
  credentials: many(provider_profiles_credentials, {
    relationName: 'credentials',
  }),
  approaches: many(provider_profiles_approaches, {
    relationName: 'approaches',
  }),
  faq: many(provider_profiles_faq, {
    relationName: 'faq',
  }),
  sessionFormats: many(provider_profiles_session_formats, {
    relationName: 'sessionFormats',
  }),
  intakeForm: one(forms, {
    fields: [provider_profiles.intakeForm],
    references: [forms.id],
    relationName: 'intakeForm',
  }),
  approvedBy: one(users, {
    fields: [provider_profiles.approvedBy],
    references: [users.id],
    relationName: 'approvedBy',
  }),
  meta_image: one(media, {
    fields: [provider_profiles.meta_image],
    references: [media.id],
    relationName: 'meta_image',
  }),
  _rels: many(provider_profiles_rels, {
    relationName: '_rels',
  }),
}))
...
export const relations_reviews = relations(reviews, ({ one }) => ({
  provider: one(provider_profiles, {
    fields: [reviews.provider],
    references: [provider_profiles.id],
...
export const relations_match_responses_responses = relations(
  match_responses_responses,
  ({ one }) => ({
    _parentID: one(match_responses, {
      fields: [match_responses_responses._parentID],
      references: [match_responses.id],
      relationName: 'responses',
    }),
  }),
)
export const relations_match_responses_rels = relations(match_responses_rels, ({ one }) => ({
  parent: one(match_responses, {
    fields: [match_responses_rels.parent],
    references: [match_responses.id],
    relationName: '_rels',
  }),
  'provider-profilesID': one(provider_profiles, {
    fields: [match_responses_rels['provider-profilesID']],
    references: [provider_profiles.id],
    relationName: 'provider-profiles',
  }),
}))
export const relations_match_responses = relations(match_responses, ({ one, many }) => ({
  responses: many(match_responses_responses, {
    relationName: 'responses',
  }),
  recommendedProvider: one(provider_profiles, {
    fields: [match_responses.recommendedProvider],
    references: [provider_profiles.id],
    relationName: 'recommendedProvider',
  }),
  _rels: many(match_responses_rels, {
    relationName: '_rels',
  }),
}))
...
export const relations_payload_locked_documents_rels = relations(
  ...
  ({ one }) => ({
    ...
    'provider-profilesID': one(provider_profiles, {
      fields: [payload_locked_documents_rels['provider-profilesID']],
      references: [provider_profiles.id],
      relationName: 'provider-profiles',
    }),
    servicesID: one(services, {
    ...
    'match-responsesID': one(match_responses, {
      fields: [payload_locked_documents_rels['match-responsesID']],
      references: [match_responses.id],
      relationName: 'match-responses',
    }),
...
export const relations_header_mobile_menu_items = relations(
  header_mobile_menu_items,
  ({ one }) => ({
    _parentID: one(header, {
      fields: [header_mobile_menu_items._parentID],
      references: [header.id],
      relationName: 'mobileMenuItems',
    }),
  }),
)
export const relations_header_rels = relations(header_rels, ({ one }) => ({
  ...
  'provider-profilesID': one(provider_profiles, {
    fields: [header_rels['provider-profilesID']],
    references: [provider_profiles.id],
    relationName: 'provider-profiles',
  }),
}))
export const relations_header = relations(header, ({ many }) => ({
  ...
  mobileMenuItems: many(header_mobile_menu_items, {
    relationName: 'mobileMenuItems',
  }),
...
export const relations_footer_rels = relations(footer_rels, ({ one }) => ({
  ...
  'provider-profilesID': one(provider_profiles, {
    fields: [footer_rels['provider-profilesID']],
    references: [provider_profiles.id],
    relationName: 'provider-profiles',
  }),
}))
...
type DatabaseSchema = {
  ...
  enum_pages_hero_background_blob: typeof enum_pages_hero_background_blob
  ...
  enum__pages_v_version_hero_background_blob: typeof enum__pages_v_version_hero_background_blob
  ...
  enum_provider_profiles_approaches_name: typeof enum_provider_profiles_approaches_name
  enum_provider_profiles_session_formats_format: typeof enum_provider_profiles_session_formats_format
  enum_provider_profiles_approval_status: typeof enum_provider_profiles_approval_status
  enum_provider_profiles_status: typeof enum_provider_profiles_status
  enum_services_category: typeof enum_services_category
  enum_reviews_author_age: typeof enum_reviews_author_age
  enum_reviews_status: typeof enum_reviews_status
  enum_bookings_format: typeof enum_bookings_format
  ...
  enum_header_mobile_menu_items_link_type: typeof enum_header_mobile_menu_items_link_type
  enum_footer_nav_items_link_type: typeof enum_footer_nav_items_link_type
  pages_hero_links: typeof pages_hero_links
  pages_hero_suggestions: typeof pages_hero_suggestions
  ...
  pages_blocks_service_carousel: typeof pages_blocks_service_carousel
  ...
  pages_blocks_featured_posts: typeof pages_blocks_featured_posts
  pages: typeof pages
  ...
  _pages_v_version_hero_suggestions: typeof _pages_v_version_hero_suggestions
  ...
  _pages_v_blocks_service_carousel: typeof _pages_v_blocks_service_carousel
  ...
  _pages_v_blocks_featured_posts: typeof _pages_v_blocks_featured_posts
  ...
  users: typeof users
  provider_profiles_credentials: typeof provider_profiles_credentials
  provider_profiles_approaches: typeof provider_profiles_approaches
  provider_profiles_faq: typeof provider_profiles_faq
  provider_profiles_session_formats: typeof provider_profiles_session_formats
  provider_profiles: typeof provider_profiles
  provider_profiles_rels: typeof provider_profiles_rels
  services: typeof services
  reviews: typeof reviews
  languages: typeof languages
  bookings: typeof bookings
  match_responses_responses: typeof match_responses_responses
  match_responses: typeof match_responses
  match_responses_rels: typeof match_responses_rels
  ...
  header_mobile_menu_items: typeof header_mobile_menu_items
  ...
  relations_pages_hero_suggestions: typeof relations_pages_hero_suggestions
  ...
  relations_pages_blocks_service_carousel: typeof relations_pages_blocks_service_carousel
  ...
  relations_pages_blocks_featured_posts: typeof relations_pages_blocks_featured_posts
  ...
  relations__pages_v_version_hero_suggestions: typeof relations__pages_v_version_hero_suggestions
  ...
  relations__pages_v_blocks_service_carousel: typeof relations__pages_v_blocks_service_carousel
  ...
  relations__pages_v_blocks_featured_posts: typeof relations__pages_v_blocks_featured_posts
  ...
  relations_provider_profiles_credentials: typeof relations_provider_profiles_credentials
  relations_provider_profiles_approaches: typeof relations_provider_profiles_approaches
  relations_provider_profiles_faq: typeof relations_provider_profiles_faq
  relations_provider_profiles_session_formats: typeof relations_provider_profiles_session_formats
  relations_provider_profiles_rels: typeof relations_provider_profiles_rels
  relations_provider_profiles: typeof relations_provider_profiles
  ...
  relations_match_responses_responses: typeof relations_match_responses_responses
  relations_match_responses_rels: typeof relations_match_responses_rels
  relations_match_responses: typeof relations_match_responses
  ...
  relations_header_mobile_menu_items: typeof relations_header_mobile_menu_items
